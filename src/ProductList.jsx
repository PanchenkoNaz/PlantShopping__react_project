...
// import { useState } from 'react';
// import { useDispatch } from 'react-redux'; // Redux dispatch for cart actions
// import { addItem } from './CartSlice'; // Redux action to add items to cart
// import './ProductList.css';
// import CartItem from './CartItem'; // Component for the shopping cart

// function ProductList() {
//   const [showCart, setShowCart] = useState(false); // State for toggling the cart view
...
//       ],
//     },
//     // Other categories and plants go here (trimmed for brevity)
//   ];

//   const handleAddToCart = (plant) => {
//     dispatch(addItem(plant)); // Dispatch the plant to Redux store
//     setAddedToCart((prevState) => ({
//       ...prevState,
//       [plant.id]: true, // Mark plant as added
//     }));
//   };
